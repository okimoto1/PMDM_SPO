...
#pdbind_with_pocket = {
#    'name': 'pdbind',
#    'atom_index': {1: 0, 5: 1, 6: 2, 7: 3, 8: 4, 9: 5, 14: 6, 15: 7, 16: 8, 17: 9, 23: 10, 26: 11, 27: 12, 29: 13, 33: 14, 34: 15, 35: 16, 44: 17, 51: 18, 53: 19, 78:20, 119: 21},
#    'atom_encoder': {'H': 0, 'B':1, 'C': 2, 'N': 3, 'O': 4, 'F': 5,'Si': 6, 'P': 7, 'S': 8, 'Cl': 9, 'V': 10, 'Fe': 11, 'Co': 12, 'Cu': 13, 'As': 14, 'Se': 15, 'Br': 16, 'Ru': 17, 'Sb': 18, 'I': 19, 'Pt': 20,  'others': 21},
#    'atom_decoder': ['H', 'B', 'C', 'N', 'O', 'F','Si', 'P', 'S', 'Cl', 'V', 'Fe', 'Co', 'Cu', 'As', 'Se', 'Br', 'Ru', 'Sb', 'I', 'Pt',  'others'],
#    'n_nodes': {10: 108, 22: 156, 9: 77, 31: 117, 33: 104, 19: 118, 17: 103, 27: 155, 23: 141, 26: 143,
#                21: 146,  7: 30, 54: 17, 28: 138, 51: 28,  42: 46,  30: 86,  15: 85,  40: 60,  24: 115,
#                11: 92,  48: 25, 25: 148,12: 119, 32: 86,  46: 30,  37: 69,  20: 177, 29: 113, 14: 93,
#                35: 84,  61: 5,  49: 36,  6: 18,  38: 62,  43: 23,  34: 77,  44: 26,  18: 115, 39: 58,
#                16: 106, 13: 136,41: 35, 36: 65,  63: 4,   56: 7,   59: 3,   55: 15,  57: 16,  45: 43,
#                50: 16,  47: 23, 53: 13, 66: 8,    8: 28,  52: 12,  67: 2,   65: 4,   60: 5,   58: 7,
#                68: 9,   64: 3,  62: 3,  70: 5,   71: 1,   69: 2},
#}

pdbind_with_pocket = {
    'name': 'pdbbind',
    'atom_index': {1: 0,  6: 1, 7: 2, 8: 3, 9: 4, 15: 5, 16: 6, 17: 7, 34: 8, 119: 9, 1000: 10},
    'atom_encoder': {'H': 0, 'C': 1, 'N': 2, 'O': 3, 'F': 4, 'P': 5, 'S': 6, 'Cl': 7, 'Se': 8, 'others': 9},
    'atom_decoder': ['H', 'C', 'N', 'O', 'F', 'P', 'S', 'Cl', 'Se', 'others'],
    'n_nodes': {10: 108, 22: 156, 9: 77, 31: 117, 33: 104, 19: 118, 17: 103, 27: 155, 23: 141, 26: 143,
                21: 146,  7: 30, 54: 17, 28: 138, 51: 28,  42: 46,  30: 86,  15: 85,  40: 60,  24: 115,
...
import os
if os.getenv("WATER") == "ligand":
    pdbind_with_pocket['atom_encoder']['water'] = 10
    pdbind_with_pocket['atom_decoder'].append('water')
...
def get_dataset_info(dataset_name, remove_h):
    if dataset_name == 'qm9':
        ...
        if not remove_h:
            ...
            raise Exception('Missing config for %s without hydrogens' % dataset_name)
    elif dataset_name == 'pdbind' or dataset_name == 'crossdock_pdbind':
        return pdbind_with_pocket
    else:
